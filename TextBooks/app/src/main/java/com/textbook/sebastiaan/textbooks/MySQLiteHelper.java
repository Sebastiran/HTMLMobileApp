...
public class MySQLiteHelper extends SQLiteOpenHelper{
    ...
    // Creating the table
    private static final String DATABASE_CREATE_ASSIGNMENTS = "CREATE TABLE " + TABLE_ASSIGNMENTS + "(" + COLUMN_ASSIGNMENT_ID + " integer primary key autoincrement, " + COLUMN_BOOK + " text not null, " + COLUMN_AUTHOR + " text not null" + ");";
